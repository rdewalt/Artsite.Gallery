...
resource "aws_cloudfront_origin_access_control" "default" {
  name                              = "default_oac"
  description                       = "Default OAC Policy"
...
resource "aws_cloudfront_distribution" "s3_thumbs_distribution" {
  origin {
    domain_name              = aws_s3_bucket.image_thumbnails.bucket_regional_domain_name
    origin_access_control_id = aws_cloudfront_origin_access_control.default.id
    origin_id                = local.s3_origin_id
  }
